            ...
            <div class="footer-col">
                ...
                <div class="footer-contacts-list">
                    <div class="footer-contact-item">
                        ...
                        <div class="footer-contact-info"><span class="footer-contact-label">Телефон</span><a href="tel:+79818881337" class="footer-phone-big">+7 (981) 888-13-37</a></div>
                    </div>
                    <div class="footer-contact-item">
                        ...
                        <div class="footer-contact-info"><span class="footer-contact-label">Email</span><a href="mailto:info@rassvet-s.ru" class="footer-link">info@rassvet-s.ru</a></div>
                    </div>
                    <div class="footer-contact-item">
                        ...
                        <div class="footer-contact-info"><span class="footer-contact-label">Адрес склада</span><span style="color: #ccc; line-height: 1.4;">г. Санкт-Петербург, ул. Промышленная, д. 42</span></div>
                    </div>
                </div>
            </div>
        </div>
