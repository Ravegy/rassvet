            ...
            <div class="container">
                ...
                <div class="gallery-grid">
                    <div class="gallery-item size-large" data-cat="engine">
                        <img src="img/hero-bg.jpg" alt="Ремонт CAT" loading="lazy">
                        <div class="gallery-overlay">
                            <div class="g-tag">ENGINE_OVERHAUL</div>
                            <h3>CATERPILLAR C15</h3>
                            <div class="g-specs"><span>ID: 4821</span><span>TIME: 48H</span><span>RES: 100%</span></div>
                        </div>
                    </div>
                    <div class="gallery-item" data-cat="hydraulics">
                        <img src="img/hero-bg.jpg" alt="Гидроцилиндр" loading="lazy">
                        <div class="gallery-overlay">
                    ...
                    <div class="gallery-item" data-cat="transmission">
                        <img src="img/hero-bg.jpg" alt="КПП" loading="lazy">
                        <div class="gallery-overlay">
                    ...
                    <div class="gallery-item size-wide" data-cat="engine">
                        <img src="img/hero-bg.jpg" alt="Двигатель" loading="lazy">
                        <div class="gallery-overlay">
                            <div class="g-tag">ASSEMBLY</div>
                            <h3>CUMMINS ISX15</h3>
                            <div class="g-specs"><span>POWER: 600HP</span><span>TEST: PASSED</span></div>
                        </div>
                    </div>
                    <div class="gallery-item" data-cat="hydraulics">
                        <img src="img/hero-bg.jpg" alt="Насос" loading="lazy">
                        <div class="gallery-overlay">
